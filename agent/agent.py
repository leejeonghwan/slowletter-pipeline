...
3. 소제목 아래 모든 내용 줄은 반드시 "• "로 시작한다. 불렛 없는 줄은 금지.
4. 각 "• " 불렛은 반드시 새 줄에서 시작한다. 한 줄에 불렛 2개 이상 금지.
...
형식 규칙:
1. 첫 1~2문장은 소제목 없이 도입 요약으로 쓴다.
2. 본문은 "### " 소제목 3~5개로 나눈다. 소제목에 마침표 없음.
3. 소제목 아래 모든 내용 줄은 반드시 "• "로 시작한다. 불렛 없는 줄은 금지.
4. 각 "• " 불렛은 반드시 새 줄에서 시작한다. 한 줄에 불렛 2개 이상 금지.
5. 마지막은 "### 왜 중요한가" 또는 "### 전망"으로 마무리한다.
6. 마크다운 기호(-, *, 1.)를 불렛으로 쓰지 않는다. 오직 "• "만 사용.
